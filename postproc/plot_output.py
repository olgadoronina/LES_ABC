...
# path_base = '../ABC/both_random/3_param_1P/'
# path_base = '../ABC/sigma_random/4_params_imcmc_random_100000_03domain_N3400000/'
path_base = '../ABC/production_random/4_param_bigger_domain/'
# path_base = '../ABC/'
...
# plotting.plot_scatter(params['model']['N_params'], C_limits, path['visua'], accepted, dist)
